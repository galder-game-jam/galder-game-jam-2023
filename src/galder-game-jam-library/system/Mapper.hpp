    ...
    class Mapper : public IMapper
    {
        public:
            Mapper()
            {
                ...
                m_strToTex["player-spritemap-v9-greenpants.png"] = TextureName::PlayerSpritemapGreenpants;
                m_strToTex["player-spritemap-v9-greypants.png"] = TextureName::PlayerSpritemapGreypants;
                m_strToTex["player-spritemap-v9.png"] = TextureName::PlayerSpritemap;
                m_strToTex["player-spritemap-v9-redpants.png"] = TextureName::PlayerSpritemapRedpants;
